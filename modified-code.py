...
class FaceRecognitionApp:
    def __init__(self, root):
        ...
        # Configure camera with 180 degree rotation
        config = self.picam2.create_preview_configuration(
            main={"size": (640, 480)},
            transform=Transform(hflip=True, vflip=True)  # Apply both horizontal and vertical flip for 180° rotation
        )
        self.picam2.configure(config)
        self.picam2.start()
        print("[CAMERA] PiCamera2 initialized and started with 180° rotation")
