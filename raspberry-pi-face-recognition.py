...
from picamera2 import Picamera2  # Replace cv2 VideoCapture with Picamera2
from libcamera import Transform  # For camera configuration
...
class FaceRecognitionApp:
    def __init__(self, root):
        ...
        config = self.picam2.create_preview_configuration(
            main={"size": (screen_width, screen_height)},
    ...
    def update_frame(self):
        if recognition_active:
            ...
            # Convert color space (libcamera might use different color space)
